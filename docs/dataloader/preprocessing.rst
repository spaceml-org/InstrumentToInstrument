...
For more information on the individual editors available, please look up the ``itipy.data.editor`` module on `GitHub <https://github.com/spaceml-org/InstrumentToInstrument/blob/master/itipy/data/editor.py>`__.