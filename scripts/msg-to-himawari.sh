...
#     ["2ch-0.64-0.87um"]="[640.0, 860.0]" # Visible channels
# )
# A_bands="[640.0, 810.0]"
# B_bands="[640.0, 860.0]"
...
#     wandb_name="MSG-HIMAWARI8-3000m-${variable}"
...
declare -A variables_and_bands_2ch=(
    ["2ch-6.2-7.3um"]="[6200.0, 7300.0]" # Water vapor channels
)
A_bands="[6250.0, 7350.0]"
B_bands="[6200.0, 7300.0]"
...
declare -A variables_and_bands_5ch=(
     ["5ch-8.4-13.3um"]="[8600.0, 9600.0, 10400.0, 12400.0, 13300.0]"
)

A_bands="[8700.0, 9660.0, 10800.0, 12000.0, 13400.0]"
B_bands="[8600.0, 9600.0, 10400.0, 12400.0, 13300.0]"
