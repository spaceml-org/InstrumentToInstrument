...
#     wandb_name="GOES16-MSG-3000m-${variable}"
...
# A_bands="[8440.0, 9610.0, 10330.0, 12270.0, 13270.0]"
...
seeds=(908 2408 611 1502 2906 100 123 40)
...
for seed in "${seeds[@]}"; do
    ...
    wandb_name="GOES16-MSG-3000m-1ch-3.9um"
    python itipy/train/geo_to_geo.py \
        --config-name goes-to-msg.yaml \
        data.A_bands="$A_bands" \
        data.B_bands="$B_bands" \
