...
#
# Here we use the same training and validation months, as the testset contains only observations from one month.
# For a real training, you should split the data into training and validation sets (e.g. training=months 2-10, validation=months 11-12).
test_months = list(range(2, 12))
train_months = list(range(2, 12))
