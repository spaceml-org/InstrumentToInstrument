...
axs[1, 1].imshow(aia_dataset[1][0], cmap='sdoaia304', vmin=-1, vmax=1, origin='lower')
axs[0, 0].set_title('Original AIA 171 Å', fontsize=30)
axs[0, 1].set_title('ITI 171 Å', fontsize=30)
axs[1, 0].set_title('Original AIA 304 Å', fontsize=30)
axs[1, 1].set_title('ITI 304 Å', fontsize=30)
plt.show()
